...
class Resource extends adminjs_1.BaseResource {
    ...
    async count(filter) {
        return this.orm.em.getRepository(this.model).count((0, convert_filter_1.convertFilter)(filter));
    }
    async find(filter, params = {}) {
        ...
        const results = await this.orm.em
            ...
            .find((0, convert_filter_1.convertFilter)(filter), {
            orderBy: {
                [sortBy]: direction,
            },
            limit,
        ...
        return results.map((result) => new adminjs_1.BaseRecord((0, core_1.wrap)(result).toJSON(), this));
    }
    async findOne(id) {
        ...
        if (!result)
            return null;
        return new adminjs_1.BaseRecord((0, core_1.wrap)(result).toJSON(), this);
    }
    async findMany(ids) {
        var _a;
    ...
    async create(params) {
        ...
        const returnedParams = adminjs_1.flat.flatten((0, core_1.wrap)(instance).toJSON());
    ...
    async update(pk, params = {}) {
        ...
        const updatedInstance = (0, core_1.wrap)(instance).assign(adminjs_1.flat.unflatten(params));
        await this.validateAndSave(updatedInstance);
        const returnedParams = adminjs_1.flat.flatten((0, core_1.wrap)(updatedInstance).toJSON());
        return returnedParams;
    }
    async delete(id) {
        await this.orm.em
